      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <header className="sticky top-0 z-30 flex items-center gap-3 px-4 h-14 bg-white dark:bg-gray-900 border-b border-slate-200 dark:border-gray-800 shadow-sm dark:shadow-none">
          ...
          <div className="md:hidden flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white font-bold text-xs">A</div>
            <span className="font-semibold text-slate-800 dark:text-gray-100 text-sm">AnahtarDestek</span>
          </div>
